...
if __name__ == "__main__":
    ...
    print("*"*50)
    print(">>>>>>>>>>>> Baselines: {} dataset - {} network".format(args.experiment, args.name))
    print("Upload capacity: ", int(args.upload_capacity))
    cycle_time_json = os.path.join(cycle_time_json, "baseline_{}.json".format(str(int(args.upload_capacity)).zfill(11)))
    ...
    cycle_time_dict['mst'] = [cycle_time]
    ...
    cycle_time_dict['mct_congest'] = [cycle_time]
    ...
    cycle_time_dict['centralized'] = [cycle_time]
    ...
    cycle_time_dict['ring'] = [cycle_time]
    ...
    print("Cycle time for MATCHA+ architecture: {0:.1f} ms".format(cycle_time))
    results_file.write("MATCHA {}\n".format(cycle_time))
    cycle_time_dict['matcha'] = [cycle_time]
